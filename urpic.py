...
mean_ur = savgol_filter(mean_ur, window_length=11, polyorder=2)
mean_ur_sr = savgol_filter(mean_ur_sr, window_length=11, polyorder=2)
std_ur = savgol_filter(std_ur, window_length=11, polyorder=2)
std_ur_sr = savgol_filter(std_ur_sr, window_length=11, polyorder=2)
...
plt.grid(True)
plt.show()
plt.savefig("Mean_Utilization_sr.png")
...
plt.grid(True)
plt.show()
plt.savefig("Std_Utilization_sr.png")

...
def train_async_mappo(
    ...
    for episode in range(num_episodes):
        ...
        print(
            ...
            KL {kl_div*100:.4f}, make_span {env.time_step}, avg_reward {np.mean(list(G.values()),axis=0):.4f}, tau {current_temp:.4f},  \
...
PARAMS = {
    ...
    + "/experiment/fjsp/fjsp_same.json",
